...
In a next version we will provide **GenAI Continuity** facility. What is that ?

When invoking AI 2 times, the generated output may vary

This natural AI variation can be avoided so it is possible to expand Data Model specification while keeping **solid versioning**
